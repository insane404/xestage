...
?>
<ul>
    <li><a href="iphone-application-development.php" <?php echo $select1 ?>>iPhone App Development</a></li>
    <li><a href="android-application-development-services.php" <?php echo $select2; ?>>Android App Development</a></li>
