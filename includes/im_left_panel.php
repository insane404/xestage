...
?>
<ul>
    <li><a href="e-commerce.php" <?php echo $select1; ?>>Internet Marketing</a></li>
    <li><a href="search-engine-optimisation.php" <?php echo $select2; ?>>Search Engine Optimisation</a></li>
    <li><a href="social-media-marketing.php" <?php echo $select3; ?>>Social Media Marketing</a></li>
